...
kami_path = "../../logs/batched_gemm/GH200/KAMI_batch_fp64.csv"
magma_path = "../../logs/batched_gemm/GH200/MAGMA_batch_fp64.csv"
...
magma_df.columns = [
    'batchcount', 'm', 'n', 'k', 'magma_gflops', 'magma_time', 'cublas_gflops',
    'cublas_time'
]
