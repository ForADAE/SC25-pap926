...
run_block_test() {
    ...
    1d)
        ...
        M_TO_NUM_RANK=([16]=1 [32]=2 [64]=2 [128]=4 [192]=12)
        M_TO_NUM_ALLOC_RANK=([16]=8 [32]=8 [64]=2 [128]=4 [192]=16)
        ;;
    2d)
        exe=block_gemm_2d_half_mma
        M_TO_NUM_RANK=([16]=1 [32]=1 [64]=2 [128]=2 [192]=2)
        M_TO_NUM_ALLOC_RANK=([16]=8 [32]=1 [64]=4 [128]=4 [192]=8)
        ;;
    3d)
        exe=block_gemm_3d_half_mma
        M_TO_NUM_RANK=([16]=1 [32]=1 [64]=2 [128]=2 [192]=2)
        M_TO_NUM_ALLOC_RANK=([16]=16 [32]=1 [64]=8 [128]=8 [192]=8)
        ;;
    *)
...
run_block_test 1d "../src/block_gemm/KAMI/1d/fp16" "../../../../../logs/block_gemm/square/5090/fp16_block_square_1d_5090"
...
CONFIGS=(
    ...
    "Problem_m=32 Problem_n=32 Problem_k=32 Block_m=32 Block_n=32 Block_k=32 Warp_m=32 Warp_n=32 Warp_k=32 Instruction_m=16 Instruction_n=8 Instruction_k=16 STAGES=2"
